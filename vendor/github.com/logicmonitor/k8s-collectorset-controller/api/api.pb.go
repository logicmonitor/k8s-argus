...
func (*CollectorIDRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*CollectorIDReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
// Client API for CollectorSetController service
...
func (c *collectorSetControllerClient) CollectorID(ctx context.Context, in *CollectorIDRequest, opts ...grpc.CallOption) (*CollectorIDReply, error) {
	...
	err := grpc.Invoke(ctx, "/api.CollectorSetController/CollectorID", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for CollectorSetController service
