...
func (*CollectorIDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_0bca86ea090cbd00, []int{0}
}
...
func (dst *CollectorIDRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CollectorIDRequest.Merge(dst, src)
}
...
func (*CollectorIDReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_0bca86ea090cbd00, []int{1}
}
...
func (dst *CollectorIDReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CollectorIDReply.Merge(dst, src)
}
...
func init() { proto.RegisterFile("api.proto", fileDescriptor_api_0bca86ea090cbd00) }

var fileDescriptor_api_0bca86ea090cbd00 = []byte{
