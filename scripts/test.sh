...
lint_packages() {
  ...
  gometalinter --aggregate --vendor --exclude="zz_generated" --enable-all --disable=gas --disable=gotype --disable=lll --disable=safesql --disable=gochecknoinits --disable=gochecknoglobals --disable=dupl --deadline=900s  ./...
}
